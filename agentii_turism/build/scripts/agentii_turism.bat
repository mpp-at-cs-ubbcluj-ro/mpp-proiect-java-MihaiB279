...
@rem ##########################################################################
@rem
@rem  agentii_turism startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and AGENTII_TURISM_OPTS to pass JVM options to this script.
...
:fail
rem Set variable AGENTII_TURISM_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%AGENTII_TURISM_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%

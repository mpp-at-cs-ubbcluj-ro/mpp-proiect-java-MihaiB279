...
public class Login {
    ...
    public void onClickLogInBttn() throws IOException {
        ...
        try{
            ...
            fxmlLoader.setLocation(getClass().getResource("/com/example/agentii_turism/main.fxml"));
    ...
    public void onClickRegisterBttn() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("/com/example/agentii_turism/register.fxml"));
        AnchorPane root = fxmlLoader. load();

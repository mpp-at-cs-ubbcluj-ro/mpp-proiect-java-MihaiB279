...
public class FlightServiceORMImpl implements IFlightServices {
    private FlightRepository flightRepository;
    private ClientRepository clientRepository;
    private AgencyRepositoryORM agencyRepository;
    private BookingRepository bookingRepository;
    private Map<String, IFlightObserver> loggedClients;
    private final int defaultThreadsNo = 5;

    public FlightServiceORMImpl(FlightRepository flightRepository, ClientRepository clientRepository, AgencyRepositoryORM agencyRepository, BookingRepository bookingRepository) {
